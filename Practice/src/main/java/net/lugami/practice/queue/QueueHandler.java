...
import net.lugami.practice.queue.listener.QueueGeneralListener;
import net.lugami.practice.queue.listener.QueueItemListener;
...
public final class QueueHandler {
    ...
    // because this is called very often (it's on the player scoreboard)
