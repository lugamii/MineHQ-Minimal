...
public final class KitTypeButton extends Button {
    ...
    public KitTypeButton(KitType kitType, Callback<KitType> callback) {
    ...
    public List<String> getDescription(Player player) {
        ...
        description.add("");
        description.add(ChatColor.GOLD + "Click here to select " + ChatColor.GOLD + ChatColor.BOLD + kitType.getDisplayName() + ChatColor.GOLD + ".");
