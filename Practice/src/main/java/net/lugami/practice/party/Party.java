...
import net.lugami.practice.party.event.*;
import net.lugami.practice.pvpclasses.PvPClasses;
...
public final class Party {
    ...
    @Getter @Setter private VoiceChannel voiceChannel = null;
    ...
    Party(UUID leader) {
        ...
        if (Bukkit.getPluginManager().getPlugin("CheatBreakerAPI") != null) {
            voiceChannel = new VoiceChannel(UUIDUtils.name(leader) + "'s Party");
            CheatBreakerAPI.getInstance().createVoiceChannels(voiceChannel);
            if (Bukkit.getPlayer(leader) != null) {
                voiceChannel.addPlayer(Bukkit.getPlayer(leader));
            }
        }
    }
    ...
    public void disband() {
        ...
        CheatBreakerAPI.getInstance().deleteVoiceChannel(voiceChannel);
