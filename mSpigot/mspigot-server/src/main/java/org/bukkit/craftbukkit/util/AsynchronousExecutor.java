 ...
 * @param <C> The type of callback you provide. You may register many of these to be passed to the tab in stage 3, one at a time.
...
public final class AsynchronousExecutor<P, T, C, E extends Throwable> {
    ...
    /**
     * Uses a thread pool to pass executions to the tab.
