...
public class DedicatedServer extends MinecraftServer implements IMinecraftServer {
    ...
    protected boolean init() throws java.net.UnknownHostException { // CraftBukkit - throws UnknownHostException
        ...
        // CraftBukkit start - TODO: handle commands-line logging arguments
    ...
    public void aB() {
        ...
        // MineHQ start - better server commands queue
        ...
        while ((queuedCommand = this.commandsQueue.poll()) != null) {
            ...
            // this.getCommandHandler().a(servercommand.source, servercommand.commands); // Called in dispatchServerCommand
    ...
    public boolean getEnableCommandBlock() {
        return this.propertyManager.getBoolean("enable-commands-block", false);
    }
