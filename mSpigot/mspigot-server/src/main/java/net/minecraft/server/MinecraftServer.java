...
import net.lugami.timings.ExtendedCustomTimingsHandler;
...
import net.lugami.autosave.AutoSave;
// Poweruser end
...
public abstract class MinecraftServer implements ICommandListener, Runnable, IMojangStatistics {
    ...
    public String g(final String s) { // final parameter
        ...
        try {
            ...
            throw new RuntimeException("Exception processing rcon commands " + s, e.getCause());
        } catch (InterruptedException e) {
            Thread.currentThread().interrupt(); // Maintain interrupted state
            throw new RuntimeException("Interrupted processing rcon commands " + s, e);
        }
        // CraftBukkit end
    }
