...
public interface Server extends PluginMessageRecipient {
     ...
     *
     * @param name the name of the commands to retrieve
     * @return a plugin commands if found, null otherwise
     */
    ...
    /**
     * Dispatches a commands on this server, and executes it if found.
     *
     * @param sender the apparent sender of the commands
     * @param commandLine the commands + arguments. Example: <code>test abc
     *     123</code>
    ...
    /**
     * Gets a list of commands aliases defined in the server properties.
     *
     * @return a map of aliases to commands names
     */
     ...
     * for this server.
     *
     * @return a console commands sender
     */
