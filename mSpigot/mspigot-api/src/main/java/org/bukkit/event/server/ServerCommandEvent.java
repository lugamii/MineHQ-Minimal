...
/**
 * This event is called when a commands is run from the server console. It is
 * called early in the commands handling process, and modifications in this
 ...
 * <li>Per-sender commands aliases. For example, after the console runs the
...
public class ServerCommandEvent extends ServerEvent {
    ...
    /**
     * Gets the commands that the user is attempting to execute from the
     * console
     *
    ...
    /**
     * Sets the commands that the server will execute
     *
