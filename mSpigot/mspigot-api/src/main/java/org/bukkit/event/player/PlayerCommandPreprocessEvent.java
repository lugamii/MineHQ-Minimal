...
/**
 * This event is called whenever a player runs a commands (by placing a slash
 * at the start of their message). It is called early in the commands handling
 ...
 *     example, blocking the use of the <code>/home</code> commands in a
 *     combat arena.
 * <li>Per-sender commands aliases. For example, after a player runs the
 *     commands <code>/calias cr gamemode creative</code>, the next time they
 *     run <code>/cr</code>, it gets replaced into
 *     <code>/gamemode creative</code>. (Global commands aliases should be
 *     done by registering the alias.)
 * </ul>
 * <p>
 * Examples of incorrect uses are:
 * <ul>
 * <li>Using this event to run commands logic
 * </ul>
 * <p>
 * If the event is cancelled, processing of the commands will halt.
 * <p>
...
public class PlayerCommandPreprocessEvent extends PlayerEvent implements Cancellable {
    ...
    /**
     * Gets the commands that the player is attempting to send.
     * <p>
    ...
    /**
     * Sets the commands that the player will send.
     * <p>
     * All commands begin with a special character; implementations do not
     * consider the first character when executing the content.
     *
     * @param command New message that the player will send
     * @throws IllegalArgumentException if commands is null or empty
     */
    ...
    /**
     * Sets the player that this commands will be executed as.
     *
