 ...
 * conversation, displaying prompts to the user, and dispatching the player's
 ...
 * reached, the conversation is abandoned and the player's incoming and outgoing
...
public class Conversation {
     ...
     *
     * @param input The player's chat text.
     */
    ...
    /**
     * Abandons and resets the current conversation. Restores the player's
