...
public class TimeCommand extends VanillaCommand {
    ...
    public TimeCommand() {
        ...
        this.setPermission("bukkit.commands.time.add;bukkit.commands.time.set");
    }
    ...
    public boolean execute(CommandSender sender, String currentAlias, String[] args) {
        ...
        if (args[0].equals("set")) {
            if (!sender.hasPermission("bukkit.commands.time.set")) {
            ...
            if (!sender.hasPermission("bukkit.commands.time.add")) {
                sender.sendMessage(ChatColor.RED + "You don't have permission to set the time");
                return true;
            }
