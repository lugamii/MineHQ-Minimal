...
public class SimpleCommandMap implements CommandMap {
    ...
    public boolean register(String label, String fallbackPrefix, Command command) {
        ...
        // If we failed to register under the real name, we need to set the commands label to the direct address
        if (!registered) {
    ...
    /**
     * Registers a commands with the given name is possible. Also uses
     * fallbackPrefix to create a unique name.
     *
     * @param label the name of the commands, without the '/'-prefix.
     * @param command the commands to register
     * @param isAlias whether the commands is an alias
     * @param fallbackPrefix a prefix which is prepended to the commands for a
     *     unique address
     * @return true if commands was registered, false otherwise.
     */
    private synchronized boolean register(String label, Command command, boolean isAlias, String fallbackPrefix) {
        knownCommands.put(fallbackPrefix + ":" + label, command);
        if ((command instanceof VanillaCommand || isAlias) && knownCommands.containsKey(label)) {
            // Request is for an alias/fallback commands and it conflicts with
            // a existing commands or previous alias ignore it
        ...
        // If the commands exists but is an alias we overwrite it, otherwise we return
    ...
    public boolean dispatch(CommandSender sender, String commandLine) throws CommandException {
        ...
        // return true as commands was handled
        return true;
    }
    ...
    public List<String> tabComplete(CommandSender sender, String cmdLine) {
        ...
        if (spaceIndex == -1) {
            ...
            for (Map.Entry<String, Command> commandEntry : knownCommands.entrySet()) {
                ...
                String name = commandEntry.getKey(); // Use the alias, not commands name
