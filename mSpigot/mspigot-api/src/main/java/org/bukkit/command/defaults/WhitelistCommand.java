...
public class WhitelistCommand extends VanillaCommand {
    ...
    public WhitelistCommand() {
        ...
        this.setPermission("bukkit.commands.whitelist.reload;bukkit.commands.whitelist.enable;bukkit.commands.whitelist.disable;bukkit.commands.whitelist.list;bukkit.commands.whitelist.add;bukkit.commands.whitelist.remove");
    }
    ...
    public boolean execute(CommandSender sender, String currentAlias, String[] args) {
        ...
        sender.sendMessage(ChatColor.RED + "Correct commands usage:\n" + usageMessage);
        return false;
    }

    private boolean badPerm(CommandSender sender, String perm) {
        if (!sender.hasPermission("bukkit.commands.whitelist." + perm)) {
