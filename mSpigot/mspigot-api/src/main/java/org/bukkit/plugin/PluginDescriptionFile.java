 ...
 *    usage: Syntax error! Simply type /&lt;commands&gt; to ignite yourself.
 *  burningdeaths:
 ...
 *    usage: |
 *      /&lt;commands&gt; [player]
 *      Example: /&lt;commands&gt; - see how many times you have burned to death
 *      Example: /&lt;commands&gt; CaptainIce - see how many times CaptainIce has burned to death
 *
 *permissions:
 *  inferno.*:
...
public final class PluginDescriptionFile {
    ...
    /**
     * Gives the map of commands-name to commands-properties. Each entry in this
     * map corresponds to a single commands and the respective values are the
     * properties of the commands. Each property, <i>with the exception of
     ...
     *     <td>String</td>
     *     <td>A user-friendly description for a commands. It is useful for
     ...
     *         strings</td>
     *     <td>Alternative commands names, with special usefulness for commands
     ...
     *     <td>String</td>
     *     <td>The name of the {@link Permission} required to use the commands.
     ...
     *     <td>String</td>
     *     <td><ul>
     *         <li>Displayed to a player that attempts to use a commands, but
     ...
     *             permission node required to use the commands.
     ...
     *         returns false}. &lt;commands&gt; is a macro that is replaced
     *         the commands issued.</td>
     *     <td><blockquote><pre>usage: Syntax error! Perhaps you meant /&lt;commands&gt; PlayerName?</pre></blockquote>
     ...
     * `<code>commands</code>', while each individual commands name is
     ...
     *    usage: Syntax error! Perhaps you meant /&lt;commands&gt; PlayerName?
     *  burningdeaths:
     *    description: List how many times you have died by fire.
     *    aliases:
     *    - burning_deaths
     ...
     *      Example: /&lt;commands&gt; - see how many times you have burned to death
     *      Example: /&lt;commands&gt; CaptainIce - see how many times CaptainIce has burned to death
     *  # The next commands has no description, aliases, etc. defined, but is still valid
