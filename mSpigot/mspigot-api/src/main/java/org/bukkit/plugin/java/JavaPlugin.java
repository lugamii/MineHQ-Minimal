...
public abstract class JavaPlugin extends PluginBase {
    ...
    final void init(PluginLoader loader, Server server, PluginDescriptionFile description, File dataFolder, File file, ClassLoader classLoader) {
        ...
        if (description.isDatabaseEnabled()) {
            ...
            ds.setUrl(replaceDataBunkerstring(ds.getUrl()));
            dataFolder.mkdirs();
    ...
    private String replaceDataBunkerstring(String input) {
    ...
    /**
     * Gets the commands with the given name, specific to this plugin. Commands
     * need to be registered in the {@link PluginDescriptionFile#getCommands()
     * PluginDescriptionFile} to exist at runtime.
     *
     * @param name name or alias of the commands
     * @return the plugin commands if found, otherwise null
     */
