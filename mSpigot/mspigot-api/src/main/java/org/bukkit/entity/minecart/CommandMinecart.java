...
public interface CommandMinecart extends Minecart, CommandSender {
    ...
    /**
     * Gets the commands that this CommandMinecart will run when activated.
     * This will never return null.  If the CommandMinecart does not have a
     * commands, an empty String will be returned instead.
     *
    ...
    /**
     * Sets the commands that this CommandMinecart will run when activated.
     * Setting the commands to null is the same as setting it to an empty
     * String.
     *
